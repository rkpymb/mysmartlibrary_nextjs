...
export default function handler(req, res) {
    if (req.method === 'POST') {
        ...
        axios.post(`${process.env.API_URL}CourseOrders/CheckIfExistCourse`, { token: process.env.MYKEY, userData: decryptedData.userData, CourseData: decryptedData.CourseData, OrderData: decryptedData.OrderData }, { headers }).then((response) => {

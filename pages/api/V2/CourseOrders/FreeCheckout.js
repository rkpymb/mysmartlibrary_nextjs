...
export default function handler(req, res) {
    if (req.method === 'POST') {
        ...
        axios.post(`${process.env.API_URL}student/FreeCheckout`, { token: process.env.MYKEY, CourseData: decryptedData.CourseData, OrderData: decryptedData.OrderData }, { headers }).then((response) => {

...
import TSlistGridByCatid from '../components/List/TSlistGridByCatid'
...
function Overview({ DataA }) {
    ...
    return (
        <OverviewWrapper>
            <Head>
                <title>Test Series : {CatMainData && CatMainData.name}</title>
            </Head>
            ...
            <div className={Mstyles.MainBoxContainer}>
                        ...
                        <div className={Mstyles.secndHederBoxA}>
                            ...
                            <div>
                                {!Loading &&
                                    ...
                                    <span><span className={Mstyles.linkpageitemClick}>Test Series
                                    </span>  / <span className={Mstyles.linkpageitem}>{CatMainData && CatMainData.name.slice(0, 60)}</span></span>
                                }
                ...
                <div className={Mstyles.MainBoxContainerInner}>
                    ...
                    <div className={Mstyles.SmallConntetboxTopDevider}></div>
                        ...
                        {!Loading &&
                            <TSlistGridByCatid catid={CatMainData && CatMainData.slug}/>
                        }
                    </div>

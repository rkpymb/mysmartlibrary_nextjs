...
import VideolistMainCat from '../components/List/VideolistMainCat'
            ...
            <div className={Mstyles.MainBoxContainer}>
                        ...
                        <div className={Mstyles.secndHederBoxA}>
                            ...
                            <div>
                                {!Loading &&
                                    ...
                                    <span><span className={Mstyles.linkpageitemClick}>Videos</span>  / <span className={Mstyles.linkpageitem}>{CatMainData && CatMainData.name.slice(0, 60)}</span></span>
                                }
                ...
                <div className={Mstyles.MainBoxContainerInner}>
                    <div>
                        ...
                        {!Loading &&
                            <VideolistMainCat slug={CatMainData && CatMainData.slug} />
                        }
                    </div>

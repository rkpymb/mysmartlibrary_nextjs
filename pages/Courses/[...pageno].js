...
import CourselistGridByCatid from '../components/List/CourselistGridByCatid'
...
function Overview({ DataA }) {
    ...
    return (
        <OverviewWrapper>
            <Head>
                <title>All Courses : {CatMainData && CatMainData.name}</title>
            </Head>
            ...
            <div className={Mstyles.MainBoxContainer}>
                        ...
                        <div className={Mstyles.secndHederBoxA}>
                            ...
                            <div>
                                {!Loading &&
                                    ...
                                    <span><span className={Mstyles.linkpageitemClick}>All Courses</span>  / <span className={Mstyles.linkpageitem}>{CatMainData && CatMainData.name.slice(0, 60)}</span></span>
                                }
                ...
                <div className={Mstyles.MainBoxContainerInner}>
                    ...
                    <div className={Mstyles.SmallConntetboxTopDevider}></div>
                        ...
                        {!Loading &&
                            <CourselistGridByCatid catid={CatMainData && CatMainData.slug}/>
                        }
                    </div>
